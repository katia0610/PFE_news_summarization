...
import LanguageSwitcher from '../components/LanguageSwitcher'; // adapte le chemin
...
const UploadFiles = () => {
  ...
  >
    ...
    >
        ...
        >
          ...
          >
            ...
            <Typography variant="body2" sx={{ color: COLORS.secondry }}>
              Formats supportés : <strong>.pdf, .mp3, .wav, .ogg, .flac, .m4a,.mp4, .avi, .mov, .mkv, .png, .jpg, .jpeg, .bmp, .tiff</strong>
            </Typography>
          </Box>
     ...
     <LanguageSwitcher onLanguageChange={changeLang} />
  </Box>
);
